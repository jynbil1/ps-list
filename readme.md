...
- The `args` property contains command line arguments without the executable path:
  - On Linux: reads exact arguments from `/proc/{pid}/cmdline` when available
  - On macOS: best-effort parsing from the command line string
